...
export const highlight = "#FFD84E";

export const grey1 = "#FFFFFF";
export const grey2 = "#FAFAFA";
export const grey3 = "#F5F5F5";
export const grey4 = "#E8E8E8";
export const grey5 = "#D9D9D9";
export const grey6 = "#707070";
export const grey7 = "#595959";
export const grey8 = "#404040";
export const grey9 = "#262626";
export const grey10 = "#000000";

export const coolGrey05 = "#FDFDFE";
export const coolGrey1 = "#F8F9FA";
export const coolGrey2 = "#E2E7EB";
export const coolGrey6 = "#959FAF";
export const coolGrey8 = "#424B59";
export const coolGrey9 = "#232933";
export const coolGrey1Hover = "#FDFDFE";
...
export const brandPurple0 = "#FCF7FF";
export const brandPurple1 = "#735482";
export const brandPurple2 = "#8E68A0";
export const brandPurple3 = "#A68AB6";
...
export const azure1 = "#F0F5FF";
export const azure2 = "#D6E4FF";
export const azure3 = "#ADC6FF";
export const azure6 = "#2F54EB";
export const azure7 = "#1D39C4";
export const azure8 = "#10239E";
export const azure9 = "#061178";
